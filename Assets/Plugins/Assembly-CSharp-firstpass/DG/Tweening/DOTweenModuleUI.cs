...
namespace DG.Tweening
{
	public static class DOTweenModuleUI
	{
		...
		{
			TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.alpha, (float x) =>
			{
				target.alpha = x;
			}, endValue, duration);
		...
		{
			TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.To(() => target.color, (Color x) =>
			{
				target.color = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		{
			TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.ToAlpha(() => target.color, (Color x) =>
			{
				target.color = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		public static TweenerCore<float, float, FloatOptions> DOFillAmount(this Image target, float endValue, float duration)
		{
			...
			TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.fillAmount, (float x) =>
			{
				target.fillAmount = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => new Vector2(target.flexibleWidth, target.flexibleHeight), (Vector2 x) =>
			{
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => new Vector2(target.minWidth, target.minHeight), (Vector2 x) =>
			{
				target.minWidth = x.x;
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => new Vector2(target.preferredWidth, target.preferredHeight), (Vector2 x) =>
			{
		...
		{
			TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.To(() => target.effectColor, (Color x) =>
			{
		...
		{
			TweenerCore<Color, Color, ColorOptions> tweenerCore = DOTween.ToAlpha(() => target.effectColor, (Color x) =>
			{
				target.effectColor = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.effectDistance, (Vector2 x) =>
			{
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.anchoredPosition, (Vector2 x) =>
			{
		...
		{
			TweenerCore<Vector3, Vector3, VectorOptions> tweenerCore = DOTween.To(() => target.anchoredPosition3D, (Vector3 x) =>
			{
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.anchorMax, (Vector2 x) =>
			{
				target.anchorMax = x;
			}, endValue, duration);
			tweenerCore.SetOptions(snapping).SetTarget(target);
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.anchorMin, (Vector2 x) =>
			{
				target.anchorMin = x;
			}, endValue, duration);
			tweenerCore.SetOptions(snapping).SetTarget(target);
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.pivot, (Vector2 x) =>
			{
				target.pivot = x;
			}, endValue, duration);
			tweenerCore.SetTarget(target);
		...
		{
			TweenerCore<Vector2, Vector2, VectorOptions> tweenerCore = DOTween.To(() => target.sizeDelta, (Vector2 x) =>
			{
				target.sizeDelta = x;
			}, endValue, duration);
			tweenerCore.SetOptions(snapping).SetTarget(target);
		...
		{
			return DOTween.Punch(() => target.anchoredPosition, (Vector3 x) =>
			{
				target.anchoredPosition = x;
		...
		{
			return DOTween.Shake(() => target.anchoredPosition, (Vector3 x) =>
			{
				target.anchoredPosition = x;
		...
		public static Sequence DOJumpAnchorPos(this RectTransform target, Vector2 endValue, float jumpPower, int numJumps, float duration, bool snapping = false)
		{
			...
			Tween t = DOTween.To(() => target.anchoredPosition, (Vector2 x) =>
			{
				target.anchoredPosition = x;
			...
			s.Append(DOTween.To(() => target.anchoredPosition, (Vector2 x) =>
			{
				target.anchoredPosition = x;
		...
		{
			return DOTween.To(() => new Vector2(target.horizontalNormalizedPosition, target.verticalNormalizedPosition), (Vector2 x) =>
			{
		...
		{
			return DOTween.To(() => target.horizontalNormalizedPosition, (float x) =>
			{
		...
		{
			return DOTween.To(() => target.verticalNormalizedPosition, (float x) =>
			{
		...
		{
			TweenerCore<float, float, FloatOptions> tweenerCore = DOTween.To(() => target.value, (float x) =>
			{
				target.value = x;
			}, endValue, duration);
			tweenerCore.SetOptions(snapping).SetTarget(target);
		...
		public static TweenerCore<int, int, NoOptions> DOCounter(this Text target, int fromValue, int endValue, float duration, bool addThousandsSeparator = true, CultureInfo culture = null)
		{
			...
			TweenerCore<int, int, NoOptions> tweenerCore = DOTween.To(() => fromValue, (int x) =>
			{
				fromValue = x;
		...
		public static TweenerCore<string, string, StringOptions> DOText(this Text target, string endValue, float duration, bool richTextEnabled = true, ScrambleMode scrambleMode = ScrambleMode.None, string scrambleChars = null)
		{
			...
			TweenerCore<string, string, StringOptions> tweenerCore = DOTween.To(() => target.text, (string x) =>
			{
				target.text = x;
			}, endValue, duration);
		...
		{
			TweenerCore<Vector2, Vector2, CircleOptions> tweenerCore = DOTween.To(CirclePlugin.Get(), () => target.anchoredPosition, (Vector2 x) =>
			{
				target.anchoredPosition = x;
			}, center, duration);
